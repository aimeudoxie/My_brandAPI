    ...
    static deleteUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const userArticles = yield article_1.Article.find({ 'comments.user': userId });
                const updateArticlesPromises = userArticles.map((article) => __awaiter(this, void 0, void 0, function* () {
                    article.comments = article.comments.filter(comment => comment.userid !== userId);
                    yield article.save();
                }));
                yield Promise.all(updateArticlesPromises);
                // Delete the user
